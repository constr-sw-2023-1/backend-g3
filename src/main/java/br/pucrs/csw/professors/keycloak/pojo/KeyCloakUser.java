...
public record KeyCloakUser(String username, boolean enable, boolean emailVerified, String firstName, String lastName, String email, Map<String, String> attributes){
